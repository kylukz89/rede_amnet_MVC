 ...
 * os contratos disponíveis para se criar atendimentos
 *
 * @author  Igor Maximo
 * @date    21/06/2021
 */
public class ContratoAtendimentoAdapter extends RecyclerView.Adapter<ContratoAtendimentoAdapter.PlanoViewHolder> {
    ...
    public ContratoAtendimentoAdapter(List<ContratoRoleta> planoList) {
    ...
    public void onBindViewHolder(PlanoViewHolder holder, final int position) {
        ...
        holder.textViewEscolherPlanoAntivirus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MenuAtendimentoResposta.COD_CONTRATO_ESCOLHIDO = planoList.get(position).getCodSercli() + "";
                MenuAtendimentoResposta.COD_CONTRATO_ITEM_ESCOLHIDO = planoList.get(position).getCodContratoItem() + "";
                MenuAtendimentoResposta.ENDERECO_PLANO = planoList.get(position).getEnderecoPuro();
                MenuAtendimentoResposta.ENDERECO_NUMERO_PLANO = planoList.get(position).getNumeroPuro();

                ((MenuAtendimentoContrato) planoList.get(0).getCtx()).startActivity(planoList.get(0).getIntent());
