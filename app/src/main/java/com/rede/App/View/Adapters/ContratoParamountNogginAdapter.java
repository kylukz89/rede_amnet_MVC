...
import com.rede.App.View.View.MenuParamountNoggin;
import com.rede.App.View.View.MenuParamountNogginContrato;
 ...
 * @date    21/06/2021
 */
public class ContratoParamountNogginAdapter extends RecyclerView.Adapter<ContratoParamountNogginAdapter.PlanoViewHolder> {
    ...
    public ContratoParamountNogginAdapter(List<ContratoRoleta> planoList) {
    ...
    public void onBindViewHolder(PlanoViewHolder holder, final int position) {
        ...
        holder.textViewEscolherPlanoAntivirus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MenuParamountNoggin.COD_APP_EXTERNO = planoList.get(position).getCodAppExterno() + "";
                MenuParamountNoggin.USUR_APP = planoList.get(position).getUsuarioApp() + "";
                MenuParamountNoggin.SEN_APP = planoList.get(position).getSenhaApp();

                ((MenuParamountNogginContrato) planoList.get(0).getCtx()).startActivity(planoList.get(0).getIntent());
            }
        });
