...
public abstract class MascarasPagamento {
    public static String CPF_MASK = "###.###.###-##";
    //public static String NAME_MASK       = "###.###.###-##";
//    public static String CNPJ_MASK = "##.###.###/####-##";
    public static String CEP_MASK = "#####-###";
//    public static String CEL_MASK = "(##) #####-####";
    public static String CARTAO_MASK = "####.####.####.####";
    public static String VALIDADE_MASK = "##/####";
    ...
    public static TextWatcher insert(final String mask, final EditText ediTxt) {
        return new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String str = MascarasPagamento.unmask(s.toString());
                String mascara = "";
                if (isUpdating) {
                    old = str;
                    isUpdating = false;
