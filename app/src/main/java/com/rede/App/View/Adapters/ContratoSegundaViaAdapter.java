...
import com.rede.App.View.View.MenuSegundaViaContrato;
 ...
 * @date 21/06/2021
 */
public class ContratoSegundaViaAdapter extends RecyclerView.Adapter<ContratoSegundaViaAdapter.PlanoViewHolder> {
    ...
    public ContratoSegundaViaAdapter(List<ContratoRoleta> planoList) {
